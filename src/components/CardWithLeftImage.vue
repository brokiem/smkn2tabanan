<template>
  <div class="flex flex-col md:flex-row items-center block w-full bg-white border border-gray-300 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
    <!-- Card image -->
