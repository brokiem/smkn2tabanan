<template>
  ...
  <div class="mt-12 mb-12 container mx-auto max-w-screen-lg px-8 lg:px-0">
    ...
    <img v-if="articleHeaderImg !== ''" id="preview-img" :src="article.image_header_url" class="mb-4 rounded-sm aspect-video w-full object-contain" style="background-color: #d0d1d3;">
