  ...
  <main>
    ...
    <div class="container mx-auto px-4 md:max-w-screen-lg pt-6">
      <div class="flex justify-center block w-full p-6 bg-white items-center border  rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        <!-- Card contents -->
        <img src="/public/images/logo-smk2.png" class="h-[200px] w-[200px]" alt="Logo SMK"/>
      </div>
      ...
      <div class="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
        ...
        <!-- Warna Latar -->
        <h5 class="mb-2 mt-6 text-2xl font-base tracking-tight text-gray-700 dark:text-white">
          Warna Latar Abu - Abu
        </h5>
        <!-- Definisi -->
